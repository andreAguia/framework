...
$botao1->set_image(PASTA_FIGURAS.'pessoais.jpg',40,40); 
...
$botao2->set_url('#');
$botao2->set_image(PASTA_FIGURAS.'solicitaFerias.jpg',40,40);
...
$botao3->set_url('#');
$botao3->set_image(PASTA_FIGURAS.'trocarSenha.jpg',40,40);
